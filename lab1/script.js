...
function triangle(val1, type1, val2, type2) {
    ...
    if (type1 === "leg" && type2 === "leg") {
        ...
        if (a <= 0.000001 || b <= 0.000001) {
           return "Увага: катет занадто малий, можливе виникнення похибки";
    }
        c = Math.sqrt(a * a + b * b);
   ...
   // 2. Катет і гіпотенуза
    ...
    // 3. Катет і прилеглий кут
        ...
        if (beta <= 0.000001 || beta >= 89.999999)
            return "Кут занадто близький до 0° або 90°, можливе виникнення похибки";
        alpha = 90 - beta;
    ...
    // 4. Катет і протилежний кут
        ...
        if (alpha <= 0.000001 || alpha >= 89.999999)
            return "Кут занадто близький до 0° або 90°, можливе виникнення похибки";
        beta = 90 - alpha;
